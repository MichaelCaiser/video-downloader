...
public class UrlEncode
{
	...
	public static String urlDecode(String s)
	{
		...
		for (int i = 0; i < s.length(); i++)
		{
			...
			case '%':
				if (i + 2 < s.length())
				{
					int di = Integer.parseInt(s.substring(i + 1, i + 3), 16);
					char dc = (char) di;
					sbuf.append(dc);
					i += 2;
					break;
	...
	{
		String e = "22%2F2000000%2F9%2F0%2F115%2C35%2F640000%2F9%2F0%2F115%2C34%2F0%2F9%2F0%2F115%2C5%2F0%2F7%2F0%2F0";
		System.out.println(urlDecode(e));
	}
